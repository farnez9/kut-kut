...
**Last updated:** 2026-04-21 (session 15 shipped)
...
**Next session:** 16 — captions (caption track type, editor bound to timeline/audio track, 2D text overlay, SRT/VTT import/export).
